...
#ifndef DESAFIO_3_CII_3__SWIFT_H
#define DESAFIO_3_CII_3__SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Desafio_3_CII_3_",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Desafio_3_CII_3_11AppDelegate")
...
SWIFT_CLASS("_TtC16Desafio_3_CII_3_23MovieCollectionViewCell")
@interface MovieCollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified movieImageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified movieLabel;
...
SWIFT_CLASS("_TtC16Desafio_3_CII_3_26MovieDetailsViewController")
@interface MovieDetailsViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified movieImageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified movieTitleLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified movieDetailsLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified movieAverageLabel;
...
SWIFT_CLASS("_TtC16Desafio_3_CII_3_20MoviesViewController")
...
- (void)viewDidLoad;
- (IBAction)previousButtonPressed:(UIButton * _Nonnull)sender;
...
@interface MoviesViewController (SWIFT_EXTENSION(Desafio_3_CII_3_)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface MoviesViewController (SWIFT_EXTENSION(Desafio_3_CII_3_)) <UICollectionViewDataSource>
...
@interface MoviesViewController (SWIFT_EXTENSION(Desafio_3_CII_3_)) <UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC16Desafio_3_CII_3_13SceneDelegate")
